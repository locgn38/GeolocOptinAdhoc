...
require_once(realpath(__DIR__ . "/../inc/error.inc.php"));
require_once(realpath(__DIR__ . "/../inc/database.inc.php"));
require_once(realpath(__DIR__ . "/../inc/security.inc.php"));
...
try {
	...
	require_once(realpath(__DIR__ . "/../inc/format.inc.php"));
}
catch (Exception $e) {
	trigger_error("Caught Exception: " . $e->getMessage(), E_USER_ERROR);
}
